...
- **Stage 0 — 바닥 반등 (관찰 전용, 편입 없음)**: MTT는 급락 직후 수개월간 회복이 불가능해
  급등→급락→바닥 재상승 구간이 통째로 미감지되던 공백을 메운다. 120일 고점 대비 −20%↑ 낙폭 +
  저점 대비 +5%↑ 반등(하락 정지) + MA20 상향 전환 + MA5>MA20 + 저점 상승이 **모두** 확인된
  종목만 잡는다. 낙폭만 크고 아직 안 돌아선 종목은 유니버스 대부분이라 제외.
  신뢰도 상한 50으로 묶어 편입 컷(70/75)에 닿지 않는다.
  **백테스트 결론(2026-08-06): 알파 미검증 — 원장 편입하지 않는다.** 신호 3,328건에서
  같은 날 급락군 대비 백분위 순위가 0.498(H=60)로 동전던지기였다. 상세: `reports/backtest_stage0.md`
